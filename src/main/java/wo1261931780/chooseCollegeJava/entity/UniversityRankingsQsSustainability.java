 ...
 * @author junw
 */
@Schema(description="大学QS可持续排名")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_qs_sustainability")
public class UniversityRankingsQsSustainability implements Serializable {
    /**
     * 主键
     */
