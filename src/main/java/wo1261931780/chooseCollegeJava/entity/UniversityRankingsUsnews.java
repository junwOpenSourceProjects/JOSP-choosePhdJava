 ...
 * @author junw
 */
@ApiModel(description="大学USNews排名数据")
@Schema(description="大学USNews排名数据")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_usnews")
public class UniversityRankingsUsnews implements Serializable {
    /**
     * 主键
     */
