 ...
 * @author junw
 */
@Schema(description="大学USNews学科排名")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_usnews_subject")
public class UniversityRankingsUsnewsSubject implements Serializable {
    /**
     * 主键
     */
