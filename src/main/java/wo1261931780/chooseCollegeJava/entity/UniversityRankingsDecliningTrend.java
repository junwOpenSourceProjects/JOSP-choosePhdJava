 ...
 * @author junw
 */
@Schema(description="大学排名下降趋势")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_declining_trend")
public class UniversityRankingsDecliningTrend implements Serializable {
    /**
     * 主键
     */
