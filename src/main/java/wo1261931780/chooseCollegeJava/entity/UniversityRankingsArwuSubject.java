 ...
 * @author junw
 */
@Schema(description="大学ARWU学科排名")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_arwu_subject")
public class UniversityRankingsArwuSubject implements Serializable {
    /**
     * 主键
     */
