 ...
 * @author junw
 */
@Schema(description="大学RUR全球学术排名")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_rur_world")
public class UniversityRankingsRurWorld implements Serializable {
    /**
     * 主键
     */
