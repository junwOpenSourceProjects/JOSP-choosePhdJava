 ...
 * @author junw
 */
@Schema(description="大学EduRank地区排名")
@Data
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "computer_rank.university_rankings_edurank_region")
public class UniversityRankingsEdurankRegion implements Serializable {
    /**
     * 主键
     */
